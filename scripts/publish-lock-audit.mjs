...
const checks = [
  ...
  ["GitHub Pages preview launcher builds before serving", read("START-PASS-123.46-MOBILE-REVIEW-CONTINUITY.bat").includes("npm run build:pages") && read("START-PASS-123.46-MOBILE-REVIEW-CONTINUITY.bat").includes("npm run preview:pages")],
