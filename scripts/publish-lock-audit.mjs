...
const checks = [
  ...
  ["GitHub Pages preview launcher builds before serving", read("START-PASS-123.15-NO-WEBSITE-BADGE.bat").includes("npm run build:pages") && read("START-PASS-123.15-NO-WEBSITE-BADGE.bat").includes("npm run preview:pages")],
