...
const checks = [
  ['Pass 123.43 marker exists', css.includes('--pass12343-mobile-menu-physical-tap:1')],
  ...
  ['Navigation scripts are cache-busted to 123.43', layout.includes('site-nav-runtime.js?v=123.43') && layout.includes('site-link-preview-lock.js?v=123.43')],
  ['Package version is 9.13.43', pkg.version === '9.13.43'],
];
