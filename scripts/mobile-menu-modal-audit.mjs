...
const checks = [
  ...
  ['Each mobile destination owns its click activation directly', runtime.includes('link.addEventListener("click", directMobileLinkClick, true)')],
  ['Primary mobile destination keeps native default navigation', !direct.includes('event.preventDefault()')],
  ['Menu closes from the anchor click itself', direct.includes('setOpen(false, false)')],
  ['Same-page navigation receives a post-click section correction', direct.includes('scrollTargetIntoView(id)')],
  ...
  ['Deployed runtime is cache-busted for this pass', layout.includes('site-nav-runtime.js?v=123.42') && layout.includes('site-link-preview-lock.js?v=123.42')],
];
